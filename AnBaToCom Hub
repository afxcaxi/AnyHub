spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red> Welcome To AnBaToCom Hub <Color=/>"):Display()
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Discord : Join LongNhat's Discord to Get the Latest Information <Color=/>"):Display()
end)
----------------------------------------------------------------------------------------------------------------------------------------------
...
do
    Tabs.Discord:AddButton(
        {
            Title = "Copy Discord LongNhat",
            Description = "https://discord.gg/DGDPGNmc",
            Callback = function()
                setclipboard("https://discord.gg/DGDPGNmc")
                Fluent:Notify(
                    {
                        Title = "AnBaToCom Hub",
                        Content = "Copied!",
    ...
    Tabs.Discord:AddButton(
        {
            Title = "Copy Youtube AfxcaxiRoblox",
            Description = "https://www.youtube.com/channel/UCppExFlPUorGZNKXp8GFtmw",
            Callback = function()
                setclipboard("https://www.youtube.com/channel/UCppExFlPUorGZNKXp8GFtmw")
                Fluent:Notify(
                    {
                        Title = "AnBaToCom Hub",
                        Content = "Copied!",
    ...
    ToggleButton.Text = "AnBaToComHub"
